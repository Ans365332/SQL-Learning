...
insert into tushar4 values( 'abcdfg' ); -- give error as it more than 5 characters
insert into tushar4 values( 'abc      ' );
...
-- datetime -- it does not autamtically update
-- timestamp -- it automatically save the date and time when u change record

-- varchar -- variable length datatype
-- char is a datatype that is fixed type and it will truncate the wide spaces at last.
-- varchar not allow extra spaces.